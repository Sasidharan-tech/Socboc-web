    ...
    export default defineConfig({
      ...
      plugins: [
        makeTagger(),
        injectedGuiListenerPlugin({
          path: 'https://SASI-resource-static.s3cdn.medo.dev/common/v2/injected.js'
        }),
        injectOnErrorPlugin(),
        ...(userConfig?.plugins || []),
...
,
        monitorPlugin(
          {
            scriptSrc: 'https://SASI-resource-static.s3cdn.medo.dev/sentry/browser.sentry.min.js',
            sentryDsn: 'https://e3c07b90fcb5207f333d50ac24a99d3e@sentry.SASI.cn/233',
            environment: 'undefined',
            appId: 'app-amvlkph9ajup'
          }
        )
      ]
    });
